...
const routes: Routes = [
  ...
  {path: 'users', component: UsersListComponent, canActivate:[AuthGuard], data:{roles:['Admin','BIBLIOTHECAIRE']}},
  {path: 'register-user', component: RegistrationComponent, canActivate:[AuthGuard], data:{roles:['Admin']}},
  {path: 'user-details/:userId', component: UserDetailsComponent, canActivate:[AuthGuard], data:{roles:['Admin','BIBLIOTHECAIRE']}},
